...
import 'package:superfood_riders_app/maps/map_utils.dart';
  ...
  confirmParcelHasBeenDelivered(getOrderId, sellerId, purchaserId, purchaserAddress, purchaserLat, purchaserLng)
  {
        ...
        }).then((value)
    {
      FirebaseFirestore.instance
          ...
          .update({
        "earnings": riderNewTotalEarningAmount, //total earnings amount rider
      });
    }).then((value)
    {
      FirebaseFirestore.instance
      ...
      body: Column(
        ...
        children: [
          ...
          GestureDetector(
            onTap: ()
            {
              //show location from rider current location toward seller location
